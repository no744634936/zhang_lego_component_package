import { computed, defineComponent, openBlock, createBlock, Fragment, createCommentVNode, resolveDynamicComponent, createTextVNode, toDisplayString, withScopeId, withModifiers } from 'vue';
...
const text_component_css_props_name_arr = without(Object.keys(text_component_props_with_defalut_value), "actionType", "url", "text");
// 
const image_component_default_props = generate_component_props(image_component_props_with_defalut_value);
const image_component_css_props_name_arr = without(Object.keys(image_component_props_with_defalut_value), 'actionType', 'url', 'src');
//
const shape_component_default_props = generate_component_props(shape_component_props_with_defalut_value);
const shape_component_css_props_name_arr = without(Object.keys(shape_component_props_with_defalut_value), 'actionType', 'url');
...
const render$2 = /*#__PURE__*/_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  return (openBlock(), createBlock(Fragment, null, [
    createCommentVNode(" component 根据tag属性的值，自动转变标签类型 "),
